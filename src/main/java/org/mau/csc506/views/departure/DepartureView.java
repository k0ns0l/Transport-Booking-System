package org.mau.csc506.views.departure;
...
@PageTitle("Departure")
@Route(value = "departure", layout = MainLayout.class)
@PermitAll
public class DepartureView extends Composite<VerticalLayout> {
